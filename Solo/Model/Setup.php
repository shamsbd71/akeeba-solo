...
class Setup extends Model
{
	...
	public function applyDatabaseParameters()
	{
		...
		/**
		 * At this point, if we are reinstalling, the db driver is already initialized with the previous settings. We need to
		 * connect to the new database. How do we do that? By abusing the container, resetting the db instance stored in it.
		 */
