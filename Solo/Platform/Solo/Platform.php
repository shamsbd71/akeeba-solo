 ...
 */
class Solo extends Base implements ContainerAwareInterface
{
	...
	public function get_local_timestamp($format = 'Y-m-d H:i:s')
	{
		...
		try
		{
			$tz = $this->get_platform_configuration_option('forced_backup_timezone', 'AKEEBA/DEFAULT') ?: 'AKEEBA/DEFAULT';
	...
	public function get_platform_database_options()
	{
		...
		if (empty($options))
		{
			$conf = $this->getContainer()->appConfig;
